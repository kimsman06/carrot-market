...
const Upload: NextPage = () => {
  return (
    <div className="px-4 py-10 space-y-5">
      ...
      <button className="w-full bg-orange-500 hover:bg-ornage-600 text-white py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 focus:outline-none">
        Upload items
      </button>
    </div>
  );
