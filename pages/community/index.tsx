      ...
      <div className="py-16 px-4 space-y-8">
        {[1, 2, 3, 4, 5, 6].map((_, i) => (
          <div key={i} className="flex cursor-pointer flex-col items-start">
            <span className="flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100">
              동네질문
            </span>
        ...
        <button className="fixed hover:bg-orange-500 cursor-pointer bottom-24 right-5 shadow-xl bg-orange-400 rounded-full p-4 text-white transition-colors">
          <svg
            className="w-6 h-6"
            fill="none"
            stroke="currentColor"
